...
const HeroSection = () => {
    ...
    return (<section className="relative min-h-[90%] overflow-hidden bg-black">
        ...
        {/* Glow Effects */}
        <div className="absolute -top-40 -right-40 h-[600px] w-[600px] rounded-full bg-red-600/20 blur-[120px]" />

        <div className="absolute -bottom-40 -left-40 h-[500px] w-[500px] rounded-full bg-orange-500/15 blur-[120px]" />
